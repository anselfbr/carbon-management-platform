...
(function () {
  ...
  const keyed = {
    ...
    "automationPageLead": {"en":"Upload all required source files. The system will consolidate work orders, calculate Standard BOM total usage, generate Product Activity and Raw Material Bulk files, map suppliers, and apply CCL factors in sequence.","zh":"上傳完整資料來源後，系統將依序完成工單彙整、標準 BOM 總用量、產品活動數據 Bulk、原物料 Bulk、供應商對應與 CCL 係數套用，最後提供兩類 Bulk 產出檔。"},
    ...
    "automationCompletedHint": {"en":"The Product Activity and Raw Material Bulk files are ready for download.","zh":"Product Activity 與 Raw Material Bulk 檔已可下載。"},
    ...
    "downloadM3aResult": {"en":"Download Raw Material Bulk","zh":"下載 Raw Material Bulk"},
