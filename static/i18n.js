...
(function () {
  ...
  const keyed = {
    ...
    "automationPageLead": {"en":"Upload all required source files. The system will consolidate work orders, calculate Standard BOM total usage, generate Product Activity Bulk, generate supplier-mapped Raw Material Bulk, and apply CCL factors in sequence. Three output packages are provided at completion.","zh":"上傳完整資料來源後，系統將依序完成工單彙整、標準 BOM 總用量、產品活動數據 Bulk、原物料 Bulk、供應商對應與 CCL 係數套用，最後提供 Product Activity、供應商對應與 CCL Raw Material 三類 Bulk 產出檔。"},
    ...
    "automationCompletedHint": {"en":"The Product Activity, supplier-mapped Raw Material, and CCL Raw Material Bulk files are ready for download.","zh":"Product Activity、供應商對應與 CCL Raw Material Bulk 檔已可下載。"},
    ...
    "downloadM2cSupplierResult": {"en":"Download Supplier-mapped Raw Material Bulk","zh":"下載供應商對應 Raw Material Bulk"},
    ...
    "automationStepM3a": {"en":"CCL Factor Application & Bulk Splitting","zh":"CCL 係數套用與 Bulk 切檔"},
