...
(function () {
  ...
  const keyed = {
    ...
    "module3aReadyTitle": {"en": "Waiting for official Raw Material batch file", "zh": "等待正式原物料批次檔"},
    "module3aReadyText": {"en": "Complete M3, then upload the official Raw Material batch file downloaded from the data center.", "zh": "請先完成 M3，再上傳資料中心下載的正式原物料批次檔。"},
