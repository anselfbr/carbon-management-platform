...
(function () {
  ...
  const keyed = {
    ...
    "module3LibraryReady": {"en": "Type an Activity Name or Reference Product Name keyword to search APOS / Cut-off factor databases automatically.", "zh": "請輸入 Activity Name 或 Reference Product Name 關鍵字後將自動搜尋 APOS / Cut-off 係數資料庫。"},
