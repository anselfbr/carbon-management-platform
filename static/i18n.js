...
(function () {
  ...
  const keyed = {
    ...
    "automationPageLead": {"en":"Upload all required source files. The system will consolidate work orders, calculate Standard BOM total usage, generate Product Activity Bulk, perform supplier mapping, and apply CCL factors in sequence. Product Activity Bulk, Supplier Bulk, and CCL Raw Material Bulk packages are provided at completion.","zh":"上傳完整資料來源後，系統將依序完成工單彙整、標準 BOM 總用量、產品活動數據 Bulk、原物料 Bulk、供應商對應與 CCL 係數套用，最後提供 Product Activity Bulk、供應商 Bulk 與 CCL Raw Material Bulk 產出檔。"},
