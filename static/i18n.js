...
(function () {
  ...
  const keyed = {
    ...
    "oneClickPipelineDesc": {"en":"One-click M1 to M3A workflow","zh":"M1 至 M3A 一鍵彙整流程"},
    "automationPageLead": {"en":"Upload all required source files, then run M1A, M2A, M1B, M2B, M2C and M3A in sequence. The final M1B and M3A Bulk files will be provided.","zh":"上傳完整資料來源後，一鍵依序執行 M1A、M2A、M1B、M2B、M2C、M3A，最後提供 M1B 與 M3A Bulk 檔。"},
    "oneClickProcess": {"en":"One-click workflow","zh":"一鍵流程"},
    "automationProductionFiles": {"en":"M1A Production Quantity Work Orders","zh":"M1A 生產數量工單"},
    "automationLaborFiles": {"en":"M1A Working Hour Work Orders","zh":"M1A 工時工單"},
    "automationBomFiles": {"en":"M2A Standard BOM Files","zh":"M2A 標準 BOM"},
    "automationProductTemplate": {"en":"M1B Product Activity Bulk Template","zh":"M1B Product Activity Bulk Template"},
    "automationRawTemplate": {"en":"M2B Raw Material Bulk Template","zh":"M2B Raw Material Bulk Template"},
    "automationSupplierFiles": {"en":"M2C Supplier Files","zh":"M2C 供應商資料"},
    "automationCclFile": {"en":"M3A CCL Mapping File","zh":"M3A CCL 係數組配表"},
    ...
    "automationCompletedHint": {"en":"M1B and M3A Bulk files are ready for download.","zh":"M1B 與 M3A Bulk 檔已可下載。"},
    "automationFailed": {"en":"Automated consolidation failed","zh":"全自動化資料彙整失敗"},
    "downloadM1bResult": {"en":"Download M1B Product Activity Bulk","zh":"下載 M1B Product Activity Bulk"},
    "downloadM3aResult": {"en":"Download M3A Raw Material Bulk","zh":"下載 M3A Raw Material Bulk"},
    ...
    "automationStepM1a": {"en":"Work Order Processing","zh":"工單處理"},
    ...
    "automationStepM2c": {"en":"Supplier Mapping","zh":"供應商對應"},
    "automationStepM3a": {"en":"CCL Factor Mapping & Split Bulk","zh":"CCL 係數對應與 Bulk 切檔"},
    "logoTitle": {
