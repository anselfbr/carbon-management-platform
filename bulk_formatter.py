...
def generate_product_activity_bulk_file(
    ...
    # Step 2 must output one unique Product Name per bulk file.
    # The third-party bulk upload checks duplicate Product Name values, so duplicate
    # Step 1 rows are consolidated here before writing Activity Data / Products.
    # Sum fields: Annual Quantity and Working Hours. Descriptive fields keep the
    # first non-blank value in the original Step 1 order.
